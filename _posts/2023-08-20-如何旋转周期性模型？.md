...
This is a note of the mechanical model of plant cell wall in [my work](https://pubs.rsc.org/en/content/articlelanding/2025/ta/d4ta07560a/unauth).
<!--more-->
...
![如何旋转周期性模型？](../assets/images/2023-08-20-如何旋转周期性模型？/p.png)
...
![如何旋转周期性模型？](../assets/images/2023-08-20-如何旋转周期性模型？/err.png)
...
![如何旋转周期性模型？](../assets/images/2023-08-20-如何旋转周期性模型？/dydx.png)
