...
This note presents a toy model based on Inverse elastica theory.
<!-- more -->
...
Consider the linear elastic constitutive $M = EI(\kappa - \bar{\kappa})$ and expand the moment and force into the two dimensional local frame,
